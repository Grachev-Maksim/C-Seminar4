...
try
{
    ...
    double dim = Countdim(x1, y1, z1, x2, y2, z2);

    Console.WriteLine($"Расстояние между ({x1},{y1},{z1}) и ({x2},{y2},{z2}) = {dim}");
}
catch
{
...
double Countdim(int x1, int y1, int z1, int x2, int y2, int z2)
{
